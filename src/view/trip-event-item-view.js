...
const createTripEventItemTemplate = (point, offersById) => {
  ...
  return `
           <li class="trip-events__item">
              <div class="event">
                <time class="event__date" datetime=${dateFrom}>${humanizeEventDateDay(dateFrom)}</time>
                ...
                <div class="event__schedule">
                  <p class="event__time">
                    <time class="event__start-time" datetime=${dateFrom}>${humanizeEventDateTime(dateFrom)}</time>
                    &mdash;
                    <time class="event__end-time" datetime=${dateTo}>${humanizeEventDateTime(dateTo)}</time>
                  </p>
